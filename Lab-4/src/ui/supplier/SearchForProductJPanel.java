...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if (productIdText == null || productIdText.isEmpty()) {
        ...
        try{
            ...
            // Display the product details (for example, in a dialog or text fields)
            JOptionPane.showMessageDialog(this, "Product found: " + foundProduct.getName(), "Product Found", JOptionPane.INFORMATION_MESSAGE);
            }else {
            // Show a message if the product is not found
            JOptionPane.showMessageDialog(this, "Product not found with ID: " + productId, "Product Not Found", JOptionPane.WARNING_MESSAGE);
        } 
