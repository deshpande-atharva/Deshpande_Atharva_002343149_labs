...
public class CreateNewProductJPanel extends javax.swing.JPanel {
    ...
    public CreateNewProductJPanel(JPanel workArea, Supplier supplier) {
        ...
        FileFilter jpegFiler= new FileNameExtensionFilter("JPEG file","jpg","jpeg");
        FileFilter pngFiler= new FileNameExtensionFilter("PNG file","png","png");
         
         
        fileChooser.addChoosableFileFilter(jpegFiler);
        fileChooser.addChoosableFileFilter(pngFiler);
        fileChooser.setFileFilter(pngFiler);
    }
    ...
    private void btnImageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImageActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                imgLogo.setIcon(logoImage);  // Set the image in the JLabel

                // Store the logo image in the Product object
                Product product = supplier.getProductCatalog().addProduct();
                product.setLogoImage(logoImage);  // Store the image in Product
